export const SERVICES_DATA = [
  {
    ...
    benefits: [
      { vn: 'Khôi phục khả năng ăn nhai 100%', en: 'Restore 100% chewing ability' },
      { vn: 'Ngăn chặn tình trạng tiêu xương hàm', en: 'Prevent jawbone loss' },
      { vn: 'Tính thẩm mỹ cao, tự nhiên như răng thật', en: 'High aesthetics, natural like real teeth' },
      { vn: 'Tuổi thọ cao, có thể tồn tại vĩnh viễn', en: 'Long lifespan, can last a lifetime' }
    ],
    duration: '2-4 buổi (tùy tình trạng)',
    enDuration: '2-4 sessions (depending on condition)'
  },
  {
    id: 'clearcorrect',
    name: 'Niềng răng ClearCorrect',
    enName: 'ClearCorrect Braces',
    category: 'Chỉnh nha',
    ...
    benefits: [
      { vn: 'Khay niềng trong suốt, gần như vô hình', en: 'Clear aligners, almost invisible' },
      { vn: 'Tháo lắp dễ dàng, thuận tiện ăn uống và vệ sinh', en: 'Easy to remove, convenient for eating and cleaning' },
      { vn: 'Hiệu quả chỉnh nha chính xác bằng công nghệ 3D', en: 'Accurate orthodontic results using 3D technology' },
      { vn: 'Không gây đau đớn, xước xát niêm mạc miệng', en: 'No pain, no scratching of the oral mucosa' }
    ],
    duration: '1-2 năm',
    enDuration: '1-2 years'
  },
  {
    id: 'rang-su',
    name: 'Bọc răng sứ thẩm mỹ',
    enName: 'Cosmetic Porcelain Crowns',
    category: 'Thẩm mỹ',
    enCategory: 'Cosmetic',
    price: '6.000.000đ',
    ...
    benefits: [
      { vn: 'Khắc phục hoàn toàn răng sứt, mẻ, ố vàng', en: 'Completely fix chipped, broken, yellowed teeth' },
      { vn: 'Màu sắc trắng sáng tự nhiên, độ trong bóng như răng thật', en: 'Natural bright white color, translucent like real teeth' },
      { vn: 'Độ bền chắc gấp 4-5 lần răng thật', en: 'Durability 4-5 times that of real teeth' },
      { vn: 'Thời gian thực hiện nhanh chóng, an toàn', en: 'Fast and safe execution time' }
    ],
    duration: '2-3 buổi',
    enDuration: '2-3 sessions'
  },
  {
    id: 'tay-trang',
    name: 'Tẩy trắng răng cấp tốc',
    enName: 'Fast Teeth Whitening',
    category: 'Thẩm mỹ',
    enCategory: 'Cosmetic',
    price: '3.500.000đ',
    ...
    benefits: [
      { vn: 'Hiệu quả trắng sáng rõ rệt chỉ sau 1 lần thực hiện', en: 'Clear whitening effect after only 1 session' },
      { vn: 'Công nghệ ánh sáng lạnh không gây ê buốt', en: 'Cold light technology does not cause sensitivity' },
      { vn: 'An toàn tuyệt đối cho men răng và nướu', en: 'Absolutely safe for enamel and gums' },
      { vn: 'Hiệu quả duy trì lâu dài từ 2-3 năm', en: 'Long-lasting effect from 2-3 years' }
    ],
    duration: '45-60 phút',
    enDuration: '45-60 minutes'
  },
  {
    id: 'nha-chu',
    name: 'Điều trị nha chu',
    enName: 'Periodontal Treatment',
    category: 'Điều trị',
    ...
    benefits: [
      { vn: 'Chấm dứt tình trạng chảy máu chân răng, hôi miệng', en: 'Stop bleeding gums, bad breath' },
      { vn: 'Loại bỏ hoàn toàn cao răng dưới nướu, mảng bám', en: 'Completely remove subgingival tartar, plaque' },
      { vn: 'Phục hồi nướu hồng hào, săn chắc', en: 'Restore pink, firm gums' },
      { vn: 'Ngăn ngừa nguy cơ lung lay và mất răng', en: 'Prevent the risk of loose and lost teeth' }
    ],
    duration: '1-3 buổi',
    enDuration: '1-3 sessions'
  },
  {
    id: 'nho-rang-khon',
    name: 'Nhổ răng khôn Piezotome',
    enName: 'Piezotome Wisdom Tooth Extraction',
    category: 'Phẫu thuật',
    enCategory: 'Surgery',
    price: '3.000.000đ',
    ...
    benefits: [
      { vn: 'Thời gian thực hiện cực nhanh, chỉ từ 10-15 phút', en: 'Extremely fast execution time, only 10-15 minutes' },
      { vn: 'Không đau, hạn chế tối đa sưng tấy, chảy máu', en: 'No pain, minimizes swelling and bleeding' },
      { vn: 'Không tổn thương dây thần kinh và mô mềm', en: 'No damage to nerves and soft tissue' },
      { vn: 'Vết thương nhỏ, thời gian hồi phục nhanh chóng', en: 'Small wound, quick recovery time' }
    ],
    duration: '15-30 phút',
    enDuration: '15-30 minutes'
  }
];
